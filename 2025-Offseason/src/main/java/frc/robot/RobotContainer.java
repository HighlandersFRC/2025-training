...
public class RobotContainer {
        ...
        Superstructure superstructure = new Superstructure(drive, peripherals, elevator, straightenator, arm,
                        manipulator,
                        intake);
        ...
        HashMap<String, Supplier<Command>> commandMap = new HashMap<String, Supplier<Command>>() {
                {
                        ...
                        put("GroundIntake", () -> new SetRobotStateSimple(superstructure,
                                        SuperState.INTAKE_IDLE));
        ...
        private void configureBindings() {
                ...
                OI.driverRT.whileTrue(
                                new SetRobotStateOnce(superstructure, SuperState.INTAKING));
