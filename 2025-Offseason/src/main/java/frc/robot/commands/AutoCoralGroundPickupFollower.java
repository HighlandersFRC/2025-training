...
// public AutoCoralGroundPickupFollower(Superstructure superstructure, Drive
// drive, double timeout) {
...
// if (superstructure.intakeHasCoral() || Timer.getFPGATimestamp() - initTime >
// timeout) {
// return true;
// } else {
// return false;
