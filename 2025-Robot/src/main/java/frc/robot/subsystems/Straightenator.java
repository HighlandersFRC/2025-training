...
public class Straightenator extends SubsystemBase {
    private final TalonFX left_straightenator = new TalonFX(Constants.CANInfo.STRAIGHTENATOR_LEFT_MOTOR_ID,
            Constants.CANInfo.CANBUS_NAME);
    private final TalonFX right_straightenator = new TalonFX(Constants.CANInfo.STRAIGHTENATOR_RIGHT_MOTOR_ID,
            Constants.CANInfo.CANBUS_NAME);
